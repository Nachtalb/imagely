...
"undefined" == typeof WeakMap && !function () {
...
}(self), window.CustomElements = window.CustomElements || {flags: {}}, function (t) {
    ...
    var v = t.flags, b = t.forSubtree, A = t.forDocumentTree, x = !window.MutationObserver || window.MutationObserver === window.JsMutationObserver;
    t.hasPolyfillMutations = x;
    var T = !1, C = [], w = Array.prototype.forEach.call.bind(Array.prototype.forEach), E = Element.prototype.createShadowRoot;
    ...
    var g, m = t.isIE, y = t.upgradeDocumentTree, v = t.upgradeAll, b = t.upgradeWithDefinition, A = t.implementPrototype, x = t.useNative, T = ["annotation-xml", "color-profile", "font-face", "font-face-src", "font-face-uri", "font-face-format", "font-face-name", "missing-glyph"], C = {}, w = "http://www.w3.org/1999/xhtml", E = document.createElement.bind(document), S = document.createElementNS.bind(document);
    ...
    var n = t.useNative, i = t.initializeModules, o = t.isIE;
    if (n) {
        var r = function () {
        };
    ...
    var s = t.upgradeDocumentTree, a = t.upgradeDocument;
    if (window.wrap || (window.ShadowDOMPolyfill ? (window.wrap = window.ShadowDOMPolyfill.wrapIfNeeded, window.unwrap = window.ShadowDOMPolyfill.unwrapIfNeeded) : window.wrap = window.unwrap = function (t) {
        ...
        }, window.CustomEvent.prototype = window.Event.prototype), "complete" === document.readyState || t.flags.eager)e(); else if ("interactive" !== document.readyState || window.attachEvent || window.HTMLImports && !window.HTMLImports.ready) {
    ...
    t = document.documentElement, e = null != (n = null != (i = null != (o = t.matchesSelector) ? o : t.webkitMatchesSelector) ? i : t.msMatchesSelector) ? n : t.mozMatchesSelector, Trix.extend({
        handleEvent: function (e, n) {
            ...
            return l = null != n ? n : {}, u = l.onElement, a = l.matchingSelector, f = l.withCallback, s = l.inPhase, c = l.preventDefault, p = l.times, o = null != u ? u : t, h = a, i = f, d = "capturing" === s, r = function (t) {
                var e;
                return null != p && 0 === --p && r.destroy(), e = Trix.findClosestElementFromNode(t.target, {matchingSelector: h}), null != e && (null != f && f.call(e, t, e), c) ? t.preventDefault() : void 0
            }, r.destroy = function () {
    ...
    var t, e, n, i;
    t = {extendsTagName: "div", css: "%t { display: block; }"}, Trix.registerElement = function (e, o) {
        var r, s, a, u, c, l, h;
        return null == o && (o = {}), e = e.toLowerCase(), c = i(o), u = null != (h = c.extendsTagName) ? h : t.extendsTagName, delete c.extendsTagName, s = c.defaultCSS, delete c.defaultCSS, null != s && u === t.extendsTagName ? s += "\n" + t.css : s = t.css, n(s, e), a = Object.getPrototypeOf(document.createElement(u)), a.__super__ = a, l = Object.create(a, c), r = document.registerElement(e, {prototype: l}), Object.defineProperty(l, "constructor", {value: r}), r
    }, n = function (t, n) {
        var i;
    ...
    Trix.config.blockAttributes = t = {
        ...
        bullet: {
            tagName: "li", listAttribute: "bulletList", test: function (e) {
                return Trix.tagName(e.parentNode) === t[this.listAttribute].tagName
            }
        },
        numberList: {tagName: "ol", parse: !1},
        number: {
            tagName: "li", listAttribute: "numberList", test: function (e) {
                return Trix.tagName(e.parentNode) === t[this.listAttribute].tagName
            }
        }
    }
    ...
    Trix.config.textAttributes = {
        bold: {
            ...
            groupTagName: "a", parser: function (t) {
                var e, n, i;
                return e = Trix.AttachmentView.attachmentSelector, i = "a:not(" + e + ")", (n = Trix.findClosestElementFromNode(t, {matchingSelector: i})) ? n.getAttribute("href") : void 0
            }
    ...
    o = "[data-trix-serialize=false]", i = ["contenteditable", "data-trix-id", "data-trix-store-key", "data-trix-mutable"], e = "data-trix-serialized-attributes", n = "[" + e + "]", t = new RegExp("<!--block-->", "g"), Trix.extend({
        serializers: {
            "application/json": function (t) {
                var e;
                if (t instanceof Trix.Document)e = t; else {
                ...
                if (r instanceof Trix.Document)c = Trix.DocumentView.render(r); else {
                ...
                for (h = 0, g = i.length; g > h; h++)for (s = i[h], A = c.querySelectorAll("[" + s + "]"), p = 0, m = A.length; m > p; p++)u = A[p], u.removeAttribute(s);
    ...
    var t = function (t, n) {
        ...
        for (var o in n)e.call(n, o) && (t[o] = n[o]);
        return i.prototype = n.prototype, t.prototype = new i, t.__super__ = n.prototype, t
    }, e = {}.hasOwnProperty, n = [].indexOf || function (t) {
        ...
        return f(i, e), o = 0, i.keyNames = {
            ...
            keydown: function (t) {
                ...
                if (this.inputSummary.composing || this.resetInputSummary(), o = this.constructor.keyNames[t.keyCode]) {
                    ...
                    null != (null != n ? n[o] : void 0) && (this.setInputSummary({keyName: o}), Trix.selectionChangeObserver.reset(), n[o].call(this, t))
                }
                ...
                return s = null != (u = t.clipboardData) ? u : t.testClipboardData, null != s ? (a = {paste: s}, h(t) ? void this.getPastedHTMLUsingHiddenElement(function (t) {
                    return function (e) {
                        var n, i, o;
                ...
                var e, n;
                return this.selectionIsExpanded() || "keypress" === this.inputSummary.eventName && this.inputSummary.textAdded || (n = null != (e = this.responder) ? e.insertPlaceholder() : void 0, this.setInputSummary({textAdded: n}), this.requestRender()), this.setInputSummary({
                    composing: !0,
    ...
    }, d = {"application/x-trix-feature-detection": "test"}, t = function (t) {
        var e, n;
        if (null != (null != t ? t.setData : void 0)) {
            for (e in d)if (n = d[e], t.setData(e, n), t.getData(e) !== n)return;
            return !0
        }
    }
}.call(this), function () {
    ...
    e = Trix.handleEvent, o = Trix.makeElement, r = Trix.tagName, n = Trix.InputController.keyNames, i = Trix.config.lang, t = Trix.config.css.classNames, Trix.AttachmentEditorController = function (u) {
        ...
        return a(c, u), l = function (t) {
            ...
            return t = this.element.querySelector("figcaption"), n = null, {
                "do": function (i) {
                    return function () {
                        return n = e("click", {onElement: t, withCallback: i.didClickCaption, inPhase: "capturing"})
                    }
                }(this), undo: function () {
                    return function () {
                        return n.destroy()
            ...
            }), e("click", {onElement: n, withCallback: this.didClickRemoveButton}), {
                "do": function (t) {
                    return function () {
            ...
            }, e("input", {onElement: a, withCallback: n}), e("keydown", {
                onElement: a,
                withCallback: this.didKeyDownCaption
            }), e("change", {onElement: a, withCallback: this.didChangeCaption}), e("blur", {
                onElement: a,
    ...
    n = Trix.makeElement, t = Trix.config.css.classNames, Trix.AttachmentView = function (o) {
        ...
        return i(r, o), r.attachmentSelector = "[data-trix-attachment]", r.prototype.createContentNodes = function () {
            ...
            if (r = n({
                ...
                }), this.attachment.hasContent())r.innerHTML = this.attachment.getContent(); else for (h = this.createContentNodes(), a = 0, c = h.length; c > a; a++)l = h[a], r.appendChild(l);
            r.appendChild(this.createCaptionElement()), i = {
                ...
                data: {trixMutable: !0, trixStoreKey: this.attachment.getCacheKey("progressElement")}
            }), r.appendChild(this.progressElement), i.trixSerialize = !1), (s = this.getHref()) ? (o = n("a", {href: s}), o.appendChild(r)) : o = r;
    ...
    t = Trix.defer, e = Trix.makeElement, n = Trix.measureElement, Trix.PreviewableAttachmentView = function (t) {
        ...
        return i(n, t), n.prototype.createContentNodes = function () {
            return this.image = e({
                tagName: "img",
                attributes: {src: ""},
                data: {trixMutable: !0, trixStoreKey: this.attachment.getCacheKey("imageElement")}
            ...
            var e, n, i, o, r;
            return o = this.attachment.getURL(), n = this.attachment.getPreloadedURL(), t.src = n || o, n === o ? t.removeAttribute("data-trix-serialized-attributes") : (i = JSON.stringify({src: o}), t.setAttribute("data-trix-serialized-attributes", i)), r = this.attachment.getWidth(), e = this.attachment.getHeight(), null != r && (t.width = r), null != e ? t.height = e : void 0
    ...
    e = Trix.makeElement, t = Trix.findInnerElement, Trix.PieceView = function (i) {
        ...
        return n(o, i), o.prototype.createNodes = function () {
            ...
            var t, e;
            return t = this.attachment.isPreviewable() ? Trix.PreviewableAttachmentView : Trix.AttachmentView, e = this.createChildView(t, this.piece.attachment, {piece: this.piece}), e.getNodes()
            ...
            var t, n, i, o, r, s, a, u;
            for (o in this.attributes)if ((t = Trix.config.textAttributes[o]) && (t.tagName && (r = e(t.tagName), i ? (i.appendChild(r), i = r) : n = i = r), t.style))if (a) {
                s = t.style;
            ...
            var t, n, i, o, r;
            o = this.attributes;
            for (i in o)if (r = o[i], (n = Trix.config.textAttributes[i]) && n.groupTagName)return t = {}, t[i] = r, e(n.groupTagName, t)
        }, r = function (t) {
            var e;
    ...
    Trix.TextView = function (e) {
        ...
        return t(n, e), n.prototype.createNodes = function () {
            ...
            for (n = [], s = function () {
                ...
                return i
            }.call(this), o = Trix.ObjectGroup.groupObjects(s), t = 0, e = o.length; e > t; t++)i = o[t], a = this.findOrCreateCachedChildView(Trix.PieceView, i, {textConfig: this.textConfig}), n.push.apply(n, a.getNodes());
            return n
        }, n
    }(Trix.ObjectView)
}.call(this), function () {
    ...
    t = Trix.makeElement, Trix.BlockView = function (n) {
        ...
        return e(i, n), i.prototype.createNodes = function () {
            var e, n, i, o, r, s, a, u, c;
            if (e = document.createComment("block"), s = [e], this.block.isEmpty() ? s.push(t("br")) : (u = null != (a = Trix.config.blockAttributes[this.block.getLastAttribute()]) ? a.text : void 0, c = this.findOrCreateCachedChildView(Trix.TextView, this.block.text, {textConfig: u}), s.push.apply(s, c.getNodes()), this.shouldAddExtraNewlineElement() && s.push(t("br"))), this.attributes.length)return s;
    ...
    t = Trix.defer, e = Trix.makeElement, Trix.DocumentView = function (i) {
        ...
        return n(o, i), o.render = function (t) {
            var n, i;
            return n = e("div"), i = new this(t, {element: n}), i.render(), i.sync(), n
        }, o.prototype.setDocument = function (t) {
            return t.isEqualTo(this.document) ? void 0 : this.document = this.object = t
        }, o.prototype.render = function () {
            var t, n, i, o, r, s, a;
            if (this.childViews = [], this.shadowElement = e("div"), !this.document.isEmpty()) {
                for (r = Trix.ObjectGroup.groupObjects(this.document.getBlocks(), {asTree: !0}), s = [], t = 0, n = r.length; n > t; t++)o = r[t], a = this.findOrCreateCachedChildView(Trix.BlockView, o), s.push(function () {
                    var t, e, n, o;
    ...
    i = Trix.handleEvent, r = Trix.tagName, n = Trix.findClosestElementFromNode, o = Trix.innerElementIsActive, e = Trix.defer, t = Trix.AttachmentView.attachmentSelector, Trix.CompositionController = function (n) {
        function r(e, n) {
            this.element = e, this.composition = n, this.didClickAttachment = s(this.didClickAttachment, this), this.didBlur = s(this.didBlur, this), this.didFocus = s(this.didFocus, this), this.documentView = new Trix.DocumentView(this.composition.document, {element: this.element}), i("focus", {
                onElement: this.element,
    ...
    e = Trix.handleEvent, n = Trix.triggerEvent, t = Trix.findClosestElementFromNode, Trix.ToolbarController = function (r) {
        function s(t) {
            ...
            }), e("keydown", {onElement: this.element, matchingSelector: h, withCallback: this.didKeyDownDialogInput})
        }
        ...
        return o(s, r), a = "button[data-action]", c = "button[data-attribute]", y = [a, c].join(", "), p = ".dialog[data-dialog]", u = p + ".active", l = p + " input[data-method]", h = p + " input[type=text], " + p + " input[type=url]", s.prototype.didClickActionButton = function (t, e) {
            ...
            var i, o;
            return i = t(n, {matchingSelector: p}), o = n.getAttribute("data-method"), this[o].call(this, i)
            ...
            var e, i, o, r, s, a, u;
            for (s = JSON.stringify(t.sort()), u = this.element.querySelectorAll("[data-key]"), r = 0, a = u.length; a > r; r++)if (e = u[r], o = e.getAttribute("data-key").split("+"), i = JSON.stringify(o.sort()), i === s)return n("mousedown", {onElement: e}), !0;
            return !1
    ...
    Trix.Attachment = function (n) {
        ...
        return e(i, n), i.previewablePattern = /^image(\/(gif|png|jpe?g)|$)/, i.attachmentForFile = function (t) {
            ...
            return new Trix.Hash({filename: t.name, filesize: t.size, contentType: t.type})
    ...
    t = Trix.arraysAreEqual, r = Trix.normalizeSpaces, i = Trix.makeElement, s = Trix.tagName, a = Trix.walkTree, n = Trix.findClosestElementFromNode, e = Trix.elementContainsNode, o = Trix.nodeIsAttachmentElement, Trix.HTMLParser = function (c) {
        ...
        return u(p, c), d = "style href src width height class".split(" "), p.parse = function (t, e) {
            ...
            var t, e;
            try {
                for (this.createHiddenContainer(), t = T(this.html), this.containerElement.innerHTML = t, e = a(this.containerElement, {usingFilter: v}); e.nextNode();)this.processNode(e.currentNode);
            ...
            var e;
            if ((null != t ? t.nodeType : void 0) === Node.ELEMENT_NODE && !n(t, {matchingSelector: "td"}))return e = s(t), l.call(this.getBlockTagNames(), e) >= 0 || "block" === window.getComputedStyle(t).display
            ...
            switch (s(t)) {
                ...
                case"img":
                    e = {url: t.getAttribute("src"), contentType: "image"}, i = y(t);
            ...
            var n;
            return null == e && (e = {}), n = "string", {string: t, attributes: e, type: n}
        }, b = function (t, e) {
            var n;
    ...
    var t, e, n, i = function (t, e) {
        ...
        for (var i in e)o.call(e, i) && (t[i] = e[i]);
        return n.prototype = e.prototype, t.prototype = new n, t.__super__ = e.prototype, t
    }, o = {}.hasOwnProperty, r = [].slice, s = [].indexOf || function (t) {
            for (var e = 0, n = this.length; n > e; e++)if (e in this && this[e] === t)return e;
            return -1
        };
    t = Trix.arraysAreEqual, e = Trix.normalizeRange, n = Trix.rangeIsCollapsed, Trix.Document = function (o) {
        ...
        return i(a, o), a.fromJSON = function (t) {
            ...
            var i, o, r;
            return o = this.expandRangeToLineBreaksAndSplitBlocks(n), i = o.document, n = o.range, Trix.config.blockAttributes[t].listAttribute ? (i = i.removeLastListAttributeAtRange(n, {exceptAttributeName: t}), r = i.convertLineBreaksToBlockBreaksInRange(n), i = r.document, n = r.range) : i = i.consolidateBlocksAtRange(n), i.addAttributeAtRange(t, e, n)
            ...
            return a = this.locationFromPosition(n), r = a.index, s = a.offset, h = this.getTextAtIndex(r), u = h.getExpandedRangeForAttributeAtOffset(t, s), l = u[0], o = u[1], c = this.positionFromLocation({
                index: r,
                offset: l
            }), i = this.positionFromLocation({index: r, offset: o}), e([c, i])
    ...
    e = Trix.normalizeRange, i = Trix.rangesAreEqual, n = Trix.objectsAreEqual, o = Trix.summarizeArrayChange, t = Trix.extend, Trix.Composition = function (s) {
        ...
        return r(a, s), a.prototype.setDocument = function (t) {
            ...
            var n, i, o, r;
            if (i = this.getSelectedRange())return o = i[0], n = i[1], o !== n ? this.setDocument(this.document.addAttributeAtRange(t, e, i)) : "href" === t ? (r = Trix.Text.textForStringWithAttributes(e, {href: e}), this.insertText(r)) : void 0
            ...
            var t, e;
            return (e = this.getSelectedRange({ignoreLock: !0})) && (t = this.document.getCommonAttributesAtRange(e), !n(t, this.currentAttributes)) ? (this.currentAttributes = t, this.notifyDelegateOfCurrentAttributesChange()) : void 0
            ...
            var e, n;
            return e = this.document.locationRangeFromRange(t), null != (n = this.delegate) ? n.compositionDidRequestChangingSelection({locationRange: e}) : void 0
        }, a.prototype.setSelectionPointRange = function (t) {
            var e;
            return null != (e = this.delegate) ? e.compositionDidRequestChangingSelection({pointRange: t}) : void 0
            ...
            var t;
            return null != (t = this.getSelectionManager().getLocationRange()) ? t : e({index: 0, offset: 0})
            ...
            if (r = this.getSelectedRange()) {
                for (o = this.document.getDocumentAtRange(r).getAttachments(), n = 0, i = o.length; i > n; n++)if (e = o[n], e.hasAttribute(t))return !0;
                return !1
            }
    ...
    Trix.Editor = function () {
        ...
        return t.prototype.loadDocument = function (t) {
            ...
            return null == t && (t = ""), this.loadDocument(Trix.Document.fromHTML(t, {referenceElement: this.element}))
    ...
    t = Trix.elementContainsNode, e = Trix.findChildIndexOfNode, n = Trix.findClosestElementFromNode, i = Trix.findNodeFromContainerAndOffset, s = Trix.nodeIsBlockStartComment, r = Trix.nodeIsBlockContainer, a = Trix.nodeIsCursorTarget, u = Trix.nodeIsEmptyTextNode, c = Trix.nodeIsTextNode, o = Trix.nodeIsAttachmentElement, l = Trix.tagName, h = Trix.walkTree, Trix.LocationMapper = function () {
        ...
        return n.prototype.findLocationFromContainerAndOffset = function (n, i) {
            ...
            for (r = 0, u = !1, l = {
                index: 0,
                offset: 0
            }, (o = this.findAttachmentElementParentForNode(n)) && (n = o.parentNode, i = e(o)), g = h(this.element, {usingFilter: d}); g.nextNode();) {
            ...
            if (0 === t.index && 0 === t.offset) {
                for (n = this.element, s = 0; n.firstChild;)if (n = n.firstChild, r(n)) {
                    s = 1;
                    break
                }
                return [n, s]
            ...
            if (a = this.findNodeAndOffsetFromLocation(t), i = a[0], o = a[1], i) {
                if (c(i))n = i, u = i.textContent, s = t.offset - o; else {
                    if (n = i.parentNode, !r(n))for (; i === n.lastChild && (i = n, n = n.parentNode, !r(n)););
                    s = e(i), 0 !== t.offset && s++
                }
                return [n, s]
            }
            ...
            for (u = 0, l = this.getSignificantNodesForIndex(t.index), n = 0, i = l.length; i > n; n++) {
                if (e = l[n], o = p(e), t.offset <= u + o)if (c(e)) {
            ...
            var e, n, o, r, a;
            for (o = [], a = h(this.element, {usingFilter: i}), r = !1; a.nextNode();)if (n = a.currentNode, s(n)) {
    ...
    t = Trix.defer, e = Trix.elementContainsNode, s = Trix.nodeIsCursorTarget, o = Trix.innerElementIsActive, r = Trix.makeElement, n = Trix.handleEvent, i = Trix.handleEventOnce, a = Trix.normalizeRange, u = Trix.rangeIsCollapsed, c = Trix.rangesAreEqual, Trix.SelectionManager = function (t) {
        ...
        return h(i, t), i.prototype.getLocationRange = function (t) {
            ...
            else if (document.caretRangeFromPoint)e = document.caretRangeFromPoint(a, u); else if (document.body.createTextRange) {
                o = m();
                try {
            ...
            if (t = m())return i = t.getClientRects(), i.length > 0 ? (r = i[0], n = i[i.length - 1], o = {
                x: r.left,
                y: r.top + 1
            }, e = {x: n.right, y: n.top + 1}, a(o, e)) : void 0
        }, y = function () {
            var t;
    ...
    e = Trix.rangeIsCollapsed, n = Trix.rangesAreEqual, t = Trix.objectsAreEqual, Trix.EditorController = function (o) {
        ...
        return i(s, o), s.prototype.registerSelectionManager = function () {
            ...
            return this.editorElement.focus(), this.thawSelection(), this.editorElement.notify("toolbar-dialog-hide", {dialogName: t})
    ...
    o = Trix.makeElement, r = Trix.triggerEvent, n = Trix.handleEvent, i = Trix.handleEventOnce, e = Trix.defer, t = Trix.AttachmentView.attachmentSelector, Trix.registerElement("trix-editor", function () {
        ...
        return u = 0, e = function (t) {
            ...
            toolbarElement: {
                get: function () {
                    var t, e, n;
                    return this.hasAttribute("toolbar") ? null != (e = this.ownerDocument) ? e.getElementById(this.getAttribute("toolbar")) : void 0 : this.parentElement ? (n = "trix-toolbar-" + this.trixId, this.setAttribute("toolbar", n), t = o("trix-toolbar", {id: n}), this.parentElement.insertBefore(t, this), t) : void 0
                }
            },
            inputElement: {
                get: function () {
            ...
            notify: function (t, e) {
                ...
                return this.editorController ? r("trix-" + t, {onElement: this, attributes: e}) : void 0
            },
            createdCallback: function () {
                return c(this)
            },
